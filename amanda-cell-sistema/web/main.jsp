            ...
            <nav class="sidebar">
                <div class="sidebar-content">
                    ...
                    <div class="sidebar-profile">
                        ...
                        <h5 class="sidebar-name">Jhon Moreno${usuario.getUsername()}</h5>
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="sidebar-item"><a class="sidebar-link" href="View/venta.jsp"><ion-icon class="align-middle"
                                                                                                         name="bag-handle"></ion-icon><span class="align-middle">Ventas</span></a></li>
                        <li class="sidebar-item"><a class="sidebar-link" href="View/reparacion.jsp"><ion-icon class="align-middle"
                                                                                                              name="construct"></ion-icon><span class="align-middle">Reparaciones</span></a>
                        </li>
                        <li class="sidebar-header">
                            Materiales
                        </li>
                        <li class="sidebar-item"><a class="sidebar-link" href="View/producto.jsp"><ion-icon class="align-middle"
                                                                                                            name="cube"></ion-icon><span class="align-middle">Productos</span></a></li>
                        <li class="sidebar-item"><a class="sidebar-link" href="View/proveedor.jsp"><ion-icon class="align-middle"
                                                                                                             name="people"></ion-icon><span class="align-middle">Proveedores</span></a>
                        </li>
                        <li class="sidebar-header">
                            Usuarios
                        </li>
                        <li class="sidebar-item"><a class="sidebar-link" href="View/cliente.jsp"><ion-icon class="align-middle"
                                                                                                           name="person-add"></ion-icon><span class="align-middle">Clientes</span></a>
                        </li>
                        <li class="sidebar-item"><a class="sidebar-link" href="View/empleado.jsp"><ion-icon class="align-middle"
                        ...
                        <li class="sidebar-item">
                            <form action="SvLogin" method="post">
                                <button name="accion" value="logout" class="btn-primary sidebar-link">
                                    <ion-icon class="align-middle" name="exit"></ion-icon>
